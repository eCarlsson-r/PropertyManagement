...
<template>
    <div class="sticky top-0 z-50 glass border-b border-white/5">
                        ...
                        <div class="flex h-full flex-1 flex-col justify-between space-y-4 py-6">
                            <nav class="-mx-3 space-y-1">
                                <Link v-for="item in mainNavItems" :key="item.title" :href="item.href"
                                    class="flex items-center gap-x-3 rounded-lg px-3 py-2 text-sm font-medium hover:bg-primary/10 hover:text-primary"
                    ...
                    <NavigationMenuList class="flex h-full items-stretch space-x-2">
                        <NavigationMenuItem v-for="(item, index) in mainNavItems" :key="index"
                            ...
                            <div v-if="isCurrentUrl(item.href)"
                                class="absolute bottom-0 left-0 h-0.5 w-full translate-y-px bg-primary shadow-[0_0_10px_var(--color-primary)]">
                            </div>
                        </NavigationMenuItem>
                    </NavigationMenuList>
                </NavigationMenu>
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger :as-child="true">
                        <Button variant="ghost" size="icon"
                            class="relative size-10 w-auto rounded-full p-1 focus-within:ring-2 focus-within:ring-primary hover:bg-primary/10">
